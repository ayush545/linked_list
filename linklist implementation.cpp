/*Program:Complete the C program to implement linked list with the function to delete the first node along with the logic to check the underflow condition. .
